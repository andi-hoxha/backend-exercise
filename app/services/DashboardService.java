...
public class DashboardService extends BaseService<Dashboard> {
    ...
    public CompletableFuture<List<Dashboard>> getAll(User user) {
        return CompletableFuture.supplyAsync(() -> {
            ...
            return publicDashboards.stream().distinct().collect(Collectors.toList()); // return List of dashboards without duplicates
        });
    }
    ...
    public CompletableFuture<Dashboard> findDashboardById(String id) {
